...
const DEFAULT_TOKENS: TokenConfig[] = [
  ...
  { name: 'TRX', address: 'TXYZopYRdj2z6j7oQJZXkXk5KXHh1zq6Y', decimals: 6, symbol: 'TRX' },
  { name: 'Tron', address: '', decimals: 6, symbol: 'TRX' }, // TRX native token has no contract address
